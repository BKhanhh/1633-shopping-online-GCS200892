		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text"> 5 days money back for broken items</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Free shipping for some orders</h6>	
				</div>
			</div><!-- .col -->
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="rating rateit-small"></div>
											<div class="product-price">	
												hsl(180, 8%, 76%)							VND. <?php echo htmlentities($row['productPrice']);?>
												</span>
